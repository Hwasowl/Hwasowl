...
**Work Experience**
- **씨앤에프시스템 (2025.12 ~ 재직)**
    - 공공기관 ERP 재무회계/예산 모듈 개발
    - Spring 백엔드 엔지니어

- **디어코퍼레이션 (2020.09 ~ 2024.01)**
    - 공유 전동 킥보드 서비스 개발 (PG결제, 회원관리, CS시스템)
    - Spring Boot, Node.js 백엔드 엔지니어

**Education**
- 가톨릭대학교 IT파이낸스 (2025.03 ~ 재학)
- 동양미래대학교 컴퓨터정보공학 (2022.03 ~ 2024.02)
